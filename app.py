...
def get_logo_url(team_name):
    ...
    # Exact match for your GitHub filenames
...
def calculate_score(predicted_rank, official_rank):
    ...
    # Prophetic Deduction (-1 for perfect pick)
...
try:
    ...
    with tab2:
        ...
        if not submissions_df.empty:
            # Sort by most recent submission per Oracle Name
    ...
    with tab4:
        ...
        #### 4. Tiered Ties
        Teams that tie in the bracket (e.g., 5th-6th) are both assigned the lower rank (5).
        """)
